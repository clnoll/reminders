...
func MakeReminderWorkflow(ctx workflow.Context, reminderDetails utils.ReminderDetails) error {
	...
	// Set query handlers
	err := workflow.SetQueryHandler(ctx, "getPhone", func() (string, error) {
		return reminderDetails.Phone, nil
	})
	if err != nil {
		return err
	}
